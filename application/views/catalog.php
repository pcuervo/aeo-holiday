<div class="[ container ] [ contenido home ] [ margin-bottom ] [ clearfix ]">
    ...
    <div class="[ row ] [ margin-bottom ] [ isotope ]">
        ...
        <div class="[ col-xs-6 col-md-3 ] [ margin-bottom ]" data-genero="hombre" data-categoria="pantalon">
        ...
        <div class="[ col-xs-6 col-md-3 ] [ margin-bottom ]" data-genero="hombre" data-categoria="accesorios">
        ...
        <div class="[ col-xs-6 col-md-3 ] [ margin-bottom ]" data-genero="mujer" data-categoria="accesorios">
