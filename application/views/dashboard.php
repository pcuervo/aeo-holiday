<div class="[ contenido home ] [ content ] [ margin-bottom ] [ clearfix ]">
    ...
    <h4 class="[ col-xs-11 center-block ] [ text-center ]">
        <?php echo $fb_user['first_name'].' '.$fb_user['last_name'] ?>
    </h4>
    <div class="[ col-xs-12 col-md-6 ] [ center-block ] [ margin-bottom clearfix ] [ main-buttons ]">
    ...
    <div class="[ col-xs-12 col-md-6 ] [ block-center ] [ clearfix ][ solicitudes-intercambio ]">
        <h3>Solicitudes</h3>
        ...
        <div class="[ invitaciones-contenedor ] [ margin-bottom clearfix ]">
            <div class="[ invitacion-intercambio ] [ margin-bottom clearfix ]">
                <div class="[ col-xs-4 ]">
                    <img src="<?php echo $invitation['admin_profile_picture']  ?>" alt="">
                </div>
                 <div class="[ col-xs-8 ]">
